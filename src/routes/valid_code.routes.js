...
router_valid_code.get("/valid_code/:valid_code_id", getValidCode);

router_valid_code.delete("/valid_code/:valid_code_id", deletedValidCode);

router_valid_code.put("/valid_code/:valid_code_id", updateValidCode);
